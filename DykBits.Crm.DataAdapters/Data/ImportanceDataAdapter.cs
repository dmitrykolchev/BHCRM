...
namespace DykBits.Crm.Data
{
    ...
    public partial class ImportanceDataAdapter : XmlDataAdapterBase<ImportanceView, Importance, ImportanceFilter>
    {
        ...
        protected override void BindBrowseResultToItem(ImportanceView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ImportanceState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(ImportanceView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ImportanceState)reader.GetByte(this._ordinal2State);
