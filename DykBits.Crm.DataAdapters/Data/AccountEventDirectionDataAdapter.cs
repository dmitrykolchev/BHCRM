...
namespace DykBits.Crm.Data
{
    ...
    public partial class AccountEventDirectionDataAdapter : XmlDataAdapterBase<AccountEventDirectionView, AccountEventDirection, AccountEventDirectionFilter>
    {
        ...
        protected override void BindBrowseResultToItem(AccountEventDirectionView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (AccountEventDirectionState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(AccountEventDirectionView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (AccountEventDirectionState)reader.GetByte(this._ordinal2State);
