...
namespace DykBits.Crm.Data
{
    ...
    public partial class SizeOfServiceRequestDataAdapter : XmlDataAdapterBase<SizeOfServiceRequestView, SizeOfServiceRequest, SizeOfServiceRequestFilter>
    {
        private bool _initialized1;
        private int _ordinal1Id;
        private int _ordinal1State;
        private int _ordinal1FileAs;
        private int _ordinal1MinimumValue;
        private int _ordinal1MaximumValue;
        ...
        private void InitializeBindBrowseResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal1MinimumValue = reader.GetOrdinal("MinimumValue");
            this._ordinal1MaximumValue = reader.GetOrdinal("MaximumValue");
        ...
        protected override void BindBrowseResultToItem(SizeOfServiceRequestView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (SizeOfServiceRequestState)reader.GetByte(this._ordinal1State);
            item.FileAs = reader.GetString(this._ordinal1FileAs);
            item.MinimumValue = reader.GetDecimal(this._ordinal1MinimumValue);
            item.MaximumValue = reader.GetDecimal(this._ordinal1MaximumValue);
        ...
        private int _ordinal2MinimumValue;
        private int _ordinal2MaximumValue;
        private void InitializeBindListResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal2MinimumValue = reader.GetOrdinal("MinimumValue");
            this._ordinal2MaximumValue = reader.GetOrdinal("MaximumValue");
            this._initialized2 = true;
        }
        protected override void BindListResultToItem(SizeOfServiceRequestView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (SizeOfServiceRequestState)reader.GetByte(this._ordinal2State);
            item.FileAs = reader.GetString(this._ordinal2FileAs);
            item.MinimumValue = reader.GetDecimal(this._ordinal2MinimumValue);
            item.MaximumValue = reader.GetDecimal(this._ordinal2MaximumValue);
        }
    }
}
