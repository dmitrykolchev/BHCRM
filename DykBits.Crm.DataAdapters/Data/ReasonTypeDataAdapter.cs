...
namespace DykBits.Crm.Data
{
    ...
    public partial class ReasonTypeDataAdapter : DataAdapterBase<ReasonTypeView, ReasonType, ReasonTypeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(ReasonTypeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ReasonTypeState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(ReasonTypeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ReasonTypeState)reader.GetByte(this._ordinal2State);
        ...
        protected override void BindGetItemResultToItem(ReasonType item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (ReasonTypeState)reader.GetByte(this._ordinal0State);
        ...
        protected override void BindCreateCommand(SqlCommand command, ReasonType item)
        {
        ...
        protected override void BindUpdateCommand(SqlCommand command, ReasonType item)
        {
