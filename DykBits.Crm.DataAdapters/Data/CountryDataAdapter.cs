...
namespace DykBits.Crm.Data
{
    ...
    public partial class CountryDataAdapter : XmlDataAdapterBase<CountryView, Country, CountryFilter>
    {
        ...
        protected override void BindBrowseResultToItem(CountryView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (CountryState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(CountryView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (CountryState)reader.GetByte(this._ordinal2State);
