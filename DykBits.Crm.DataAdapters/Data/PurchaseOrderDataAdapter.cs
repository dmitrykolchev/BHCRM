...
namespace DykBits.Crm.Data
{
    ...
    public partial class PurchaseOrderDataAdapter : XmlDataAdapterBase<PurchaseOrderView, PurchaseOrder, PurchaseOrderFilter>
    {
        ...
        protected override void BindBrowseResultToItem(PurchaseOrderView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (PurchaseOrderState)reader.GetByte(this._ordinal1State);
            ...
            item.SupplierId = reader.GetInt32(this._ordinal1SupplierId);
        ...
        protected override void BindListResultToItem(PurchaseOrderView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (PurchaseOrderState)reader.GetByte(this._ordinal2State);
            ...
            item.SupplierId = reader.GetInt32(this._ordinal2SupplierId);
