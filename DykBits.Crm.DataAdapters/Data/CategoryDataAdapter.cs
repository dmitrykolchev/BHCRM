...
namespace DykBits.Crm.Data
{
    ...
    public partial class CategoryDataAdapter : XmlDataAdapterBase<CategoryView, Category, CategoryFilter>
    {
        ...
        protected override void BindBrowseResultToItem(CategoryView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (CategoryState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(CategoryView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (CategoryState)reader.GetByte(this._ordinal2State);
