...
namespace DykBits.Crm.Data
{
    ...
    public partial class UserNotificationDataAdapter : XmlDataAdapterBase<UserNotificationView, UserNotification, UserNotificationFilter>
    {
        ...
        protected override void BindBrowseResultToItem(UserNotificationView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (UserNotificationState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(UserNotificationView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (UserNotificationState)reader.GetByte(this._ordinal2State);
