...
namespace DykBits.Crm.Data
{
    ...
    public partial class InventoryBalanceDataAdapter : ViewDataAdapterBase<InventoryBalance, ProductFilter>
    {
        ...
        private int _ordinal1IncomingAmount;
        private int _ordinal1IncomingTotalCost;
        private int _ordinal1OutgoingAmount;
        private int _ordinal1OutgoingTotalCost;
        private int _ordinal1ReservedAmount;
        private void InitializeBindBrowseResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal1IncomingAmount = reader.GetOrdinal("IncomingAmount");
            this._ordinal1IncomingTotalCost = reader.GetOrdinal("IncomingTotalCost");
            this._ordinal1OutgoingAmount = reader.GetOrdinal("OutgoingAmount");
            this._ordinal1OutgoingTotalCost = reader.GetOrdinal("OutgoingTotalCost");
            this._ordinal1ReservedAmount = reader.GetOrdinal("ReservedAmount");
            this._initialized1 = true;
        }
        protected override void BindBrowseResultToItem(InventoryBalance item, SqlDataReader reader)
        {
            ...
            if(reader.IsDBNull(_ordinal1IncomingAmount)) item.IncomingAmount = null; else item.IncomingAmount = reader.GetDecimal(this._ordinal1IncomingAmount);
            if(reader.IsDBNull(_ordinal1IncomingTotalCost)) item.IncomingTotalCost = null; else item.IncomingTotalCost = reader.GetDecimal(this._ordinal1IncomingTotalCost);
            if(reader.IsDBNull(_ordinal1OutgoingAmount)) item.OutgoingAmount = null; else item.OutgoingAmount = reader.GetDecimal(this._ordinal1OutgoingAmount);
            if(reader.IsDBNull(_ordinal1OutgoingTotalCost)) item.OutgoingTotalCost = null; else item.OutgoingTotalCost = reader.GetDecimal(this._ordinal1OutgoingTotalCost);
            if(reader.IsDBNull(_ordinal1ReservedAmount)) item.ReservedAmount = null; else item.ReservedAmount = reader.GetDecimal(this._ordinal1ReservedAmount);
        }
        ...
        private int _ordinal2IncomingAmount;
        private int _ordinal2IncomingTotalCost;
        private int _ordinal2OutgoingAmount;
        private int _ordinal2OutgoingTotalCost;
        private int _ordinal2ReservedAmount;
        private void InitializeBindListResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal2IncomingAmount = reader.GetOrdinal("IncomingAmount");
            this._ordinal2IncomingTotalCost = reader.GetOrdinal("IncomingTotalCost");
            this._ordinal2OutgoingAmount = reader.GetOrdinal("OutgoingAmount");
            this._ordinal2OutgoingTotalCost = reader.GetOrdinal("OutgoingTotalCost");
            this._ordinal2ReservedAmount = reader.GetOrdinal("ReservedAmount");
            this._initialized2 = true;
        }
        protected override void BindListResultToItem(InventoryBalance item, SqlDataReader reader)
        {
            ...
            if(reader.IsDBNull(_ordinal2IncomingAmount)) item.IncomingAmount = null; else item.IncomingAmount = reader.GetDecimal(this._ordinal2IncomingAmount);
            if(reader.IsDBNull(_ordinal2IncomingTotalCost)) item.IncomingTotalCost = null; else item.IncomingTotalCost = reader.GetDecimal(this._ordinal2IncomingTotalCost);
            if(reader.IsDBNull(_ordinal2OutgoingAmount)) item.OutgoingAmount = null; else item.OutgoingAmount = reader.GetDecimal(this._ordinal2OutgoingAmount);
            if(reader.IsDBNull(_ordinal2OutgoingTotalCost)) item.OutgoingTotalCost = null; else item.OutgoingTotalCost = reader.GetDecimal(this._ordinal2OutgoingTotalCost);
            if(reader.IsDBNull(_ordinal2ReservedAmount)) item.ReservedAmount = null; else item.ReservedAmount = reader.GetDecimal(this._ordinal2ReservedAmount);
        }
    }
}
