...
namespace DykBits.Crm.Data
{
    ...
    public partial class DocumentAccessControlListDataAdapter : XmlDataAdapterBase<DocumentAccessControlListView, DocumentAccessControlList, DocumentAccessControlListFilter>
    {
        ...
        protected override void BindBrowseResultToItem(DocumentAccessControlListView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (DocumentAccessControlListState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(DocumentAccessControlListView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (DocumentAccessControlListState)reader.GetByte(this._ordinal2State);
