...
namespace DykBits.Crm.Data
{
    ...
    public partial class VenueTypeDataAdapter : XmlDataAdapterBase<VenueTypeView, VenueType, VenueTypeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(VenueTypeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (VenueTypeState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(VenueTypeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (VenueTypeState)reader.GetByte(this._ordinal2State);
