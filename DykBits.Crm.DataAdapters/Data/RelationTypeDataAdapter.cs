...
namespace DykBits.Crm.Data
{
    ...
    public partial class RelationTypeDataAdapter : XmlDataAdapterBase<RelationTypeView, RelationType, RelationTypeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(RelationTypeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (RelationTypeState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(RelationTypeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (RelationTypeState)reader.GetByte(this._ordinal2State);
