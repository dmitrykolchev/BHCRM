...
namespace DykBits.Crm.Data
{
    ...
    public partial class OpportunityTypeDataAdapter : DataAdapterBase<OpportunityTypeView, OpportunityType, OpportunityTypeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(OpportunityTypeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (OpportunityTypeState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(OpportunityTypeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (OpportunityTypeState)reader.GetByte(this._ordinal2State);
        ...
        protected override void BindGetItemResultToItem(OpportunityType item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (OpportunityTypeState)reader.GetByte(this._ordinal0State);
        ...
        protected override void BindCreateCommand(SqlCommand command, OpportunityType item)
        {
        ...
        protected override void BindUpdateCommand(SqlCommand command, OpportunityType item)
        {
