...
namespace DykBits.Crm.Data
{
    ...
    public partial class ReasonDataAdapter : DataAdapterBase<ReasonView, Reason, ReasonFilter>
    {
        private bool _initialized1;
        private int _ordinal1Id;
        private int _ordinal1State;
        private int _ordinal1FileAs;
        private int _ordinal1ReasonTypeId;
        ...
        private void InitializeBindBrowseResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal1ReasonTypeId = reader.GetOrdinal("ReasonTypeId");
        ...
        protected override void BindBrowseResultToItem(ReasonView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ReasonState)reader.GetByte(this._ordinal1State);
            item.FileAs = reader.GetString(this._ordinal1FileAs);
            item.ReasonTypeId = reader.GetInt32(this._ordinal1ReasonTypeId);
        ...
        private int _ordinal2ReasonTypeId;
        private void InitializeBindListResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal2ReasonTypeId = reader.GetOrdinal("ReasonTypeId");
            this._initialized2 = true;
        }
        protected override void BindListResultToItem(ReasonView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ReasonState)reader.GetByte(this._ordinal2State);
            item.FileAs = reader.GetString(this._ordinal2FileAs);
            item.ReasonTypeId = reader.GetInt32(this._ordinal2ReasonTypeId);
        }
        private bool _initialized0;
        private int _ordinal0Id;
        private int _ordinal0State;
        private int _ordinal0FileAs;
        private int _ordinal0ReasonTypeId;
        ...
        private void InitializeBindGetItemResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal0ReasonTypeId = reader.GetOrdinal("ReasonTypeId");
        ...
        protected override void BindGetItemResultToItem(Reason item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (ReasonState)reader.GetByte(this._ordinal0State);
            item.FileAs = reader.GetString(this._ordinal0FileAs);
            item.ReasonTypeId = reader.GetInt32(this._ordinal0ReasonTypeId);
        ...
        protected override void BindCreateCommand(SqlCommand command, Reason item)
        {
            command.Parameters["@FileAs"].Value = DbValueConverter.Convert(item.FileAs);
            command.Parameters["@ReasonTypeId"].Value = item.ReasonTypeId;
            command.Parameters["@Comments"].Value = DbValueConverter.Convert(item.Comments);
        }
        protected override void BindUpdateCommand(SqlCommand command, Reason item)
        {
