...
namespace DykBits.Crm.Data
{
    ...
    public partial class SeasonDataAdapter : XmlDataAdapterBase<SeasonView, Season, SeasonFilter>
    {
        ...
        protected override void BindBrowseResultToItem(SeasonView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (SeasonState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(SeasonView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (SeasonState)reader.GetByte(this._ordinal2State);
