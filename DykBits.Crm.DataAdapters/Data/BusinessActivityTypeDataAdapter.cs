...
namespace DykBits.Crm.Data
{
    ...
    public partial class BusinessActivityTypeDataAdapter : XmlDataAdapterBase<BusinessActivityTypeView, BusinessActivityType, BusinessActivityTypeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(BusinessActivityTypeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (BusinessActivityTypeState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(BusinessActivityTypeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (BusinessActivityTypeState)reader.GetByte(this._ordinal2State);
