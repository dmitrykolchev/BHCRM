...
namespace DykBits.Crm.Data
{
    ...
    public partial class WriteoffStatementDataAdapter : XmlDataAdapterBase<WriteoffStatementView, WriteoffStatement, WriteoffStatementFilter>
    {
        ...
        protected override void BindBrowseResultToItem(WriteoffStatementView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (WriteoffStatementState)reader.GetByte(this._ordinal1State);
            ...
            item.Subject = reader.GetString(this._ordinal1Subject);
        ...
        protected override void BindListResultToItem(WriteoffStatementView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (WriteoffStatementState)reader.GetByte(this._ordinal2State);
            ...
            item.Subject = reader.GetString(this._ordinal2Subject);
