...
namespace DykBits.Crm.Data
{
    ...
    public partial class PositionDataAdapter : DataAdapterBase<PositionView, Position, PositionFilter>
    {
        ...
        protected override void BindBrowseResultToItem(PositionView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (PositionState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(PositionView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (PositionState)reader.GetByte(this._ordinal2State);
        ...
        protected override void BindGetItemResultToItem(Position item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (PositionState)reader.GetByte(this._ordinal0State);
        ...
        protected override void BindCreateCommand(SqlCommand command, Position item)
        {
        ...
        protected override void BindUpdateCommand(SqlCommand command, Position item)
        {
