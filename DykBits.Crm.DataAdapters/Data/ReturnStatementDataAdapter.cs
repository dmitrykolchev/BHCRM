...
namespace DykBits.Crm.Data
{
    ...
    public partial class ReturnStatementDataAdapter : XmlDataAdapterBase<ReturnStatementView, ReturnStatement, ReturnStatementFilter>
    {
        ...
        private int _ordinal1SalesOrderId;
        ...
        private void InitializeBindBrowseResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal1SalesOrderId = reader.GetOrdinal("SalesOrderId");
        ...
        protected override void BindBrowseResultToItem(ReturnStatementView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ReturnStatementState)reader.GetByte(this._ordinal1State);
            ...
            item.SalesOrderId = reader.GetInt32(this._ordinal1SalesOrderId);
        ...
        private int _ordinal2SalesOrderId;
        ...
        private void InitializeBindListResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal2SalesOrderId = reader.GetOrdinal("SalesOrderId");
        ...
        protected override void BindListResultToItem(ReturnStatementView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ReturnStatementState)reader.GetByte(this._ordinal2State);
            ...
            item.SalesOrderId = reader.GetInt32(this._ordinal2SalesOrderId);
