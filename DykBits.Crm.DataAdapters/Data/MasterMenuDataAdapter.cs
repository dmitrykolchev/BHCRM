...
namespace DykBits.Crm.Data
{
    ...
    public partial class MasterMenuDataAdapter : XmlDataAdapterBase<MasterMenuView, MasterMenu, MasterMenuFilter>
    {
        ...
        private int _ordinal1DishIngredientId;
        private int _ordinal1DishTypeId;
        private int _ordinal1DishSubtypeId;
        private int _ordinal1DishCourseId;
        private int _ordinal1DishOccasionId;
        private int _ordinal1DishWorldId;
        private int _ordinal1DishServingMask;
        private int _ordinal1DishCookingMethodId;
        private int _ordinal1SeasonMask;
        private int _ordinal1ServiceRequestTypeMask;
        private int _ordinal1ServingAmount;
        ...
        private void InitializeBindBrowseResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal1DishIngredientId = reader.GetOrdinal("DishIngredientId");
            this._ordinal1DishTypeId = reader.GetOrdinal("DishTypeId");
            this._ordinal1DishSubtypeId = reader.GetOrdinal("DishSubtypeId");
            this._ordinal1DishCourseId = reader.GetOrdinal("DishCourseId");
            this._ordinal1DishOccasionId = reader.GetOrdinal("DishOccasionId");
            this._ordinal1DishWorldId = reader.GetOrdinal("DishWorldId");
            this._ordinal1DishServingMask = reader.GetOrdinal("DishServingMask");
            this._ordinal1DishCookingMethodId = reader.GetOrdinal("DishCookingMethodId");
            this._ordinal1SeasonMask = reader.GetOrdinal("SeasonMask");
            this._ordinal1ServiceRequestTypeMask = reader.GetOrdinal("ServiceRequestTypeMask");
            this._ordinal1ServingAmount = reader.GetOrdinal("ServingAmount");
        ...
        protected override void BindBrowseResultToItem(MasterMenuView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (MasterMenuState)reader.GetByte(this._ordinal1State);
            ...
            if(reader.IsDBNull(_ordinal1DishIngredientId)) item.DishIngredientId = null; else item.DishIngredientId = reader.GetInt32(this._ordinal1DishIngredientId);
            if(reader.IsDBNull(_ordinal1DishTypeId)) item.DishTypeId = null; else item.DishTypeId = reader.GetInt32(this._ordinal1DishTypeId);
            if(reader.IsDBNull(_ordinal1DishSubtypeId)) item.DishSubtypeId = null; else item.DishSubtypeId = reader.GetInt32(this._ordinal1DishSubtypeId);
            if(reader.IsDBNull(_ordinal1DishCourseId)) item.DishCourseId = null; else item.DishCourseId = reader.GetInt32(this._ordinal1DishCourseId);
            if(reader.IsDBNull(_ordinal1DishOccasionId)) item.DishOccasionId = null; else item.DishOccasionId = reader.GetInt32(this._ordinal1DishOccasionId);
            if(reader.IsDBNull(_ordinal1DishWorldId)) item.DishWorldId = null; else item.DishWorldId = reader.GetInt32(this._ordinal1DishWorldId);
            if(reader.IsDBNull(_ordinal1DishServingMask)) item.DishServingMask = null; else item.DishServingMask = reader.GetInt32(this._ordinal1DishServingMask);
            if(reader.IsDBNull(_ordinal1DishCookingMethodId)) item.DishCookingMethodId = null; else item.DishCookingMethodId = reader.GetInt32(this._ordinal1DishCookingMethodId);
            if(reader.IsDBNull(_ordinal1SeasonMask)) item.SeasonMask = null; else item.SeasonMask = reader.GetInt32(this._ordinal1SeasonMask);
            if(reader.IsDBNull(_ordinal1ServiceRequestTypeMask)) item.ServiceRequestTypeMask = null; else item.ServiceRequestTypeMask = reader.GetInt32(this._ordinal1ServiceRequestTypeMask);
            if(reader.IsDBNull(_ordinal1ServingAmount)) item.ServingAmount = null; else item.ServingAmount = reader.GetDecimal(this._ordinal1ServingAmount);
        ...
        private int _ordinal2DishIngredientId;
        private int _ordinal2DishTypeId;
        private int _ordinal2DishSubtypeId;
        private int _ordinal2DishCourseId;
        private int _ordinal2DishOccasionId;
        private int _ordinal2DishWorldId;
        private int _ordinal2DishServingMask;
        private int _ordinal2DishCookingMethodId;
        private int _ordinal2SeasonMask;
        private int _ordinal2ServiceRequestTypeMask;
        private int _ordinal2ServingAmount;
        private void InitializeBindListResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal2DishIngredientId = reader.GetOrdinal("DishIngredientId");
            this._ordinal2DishTypeId = reader.GetOrdinal("DishTypeId");
            this._ordinal2DishSubtypeId = reader.GetOrdinal("DishSubtypeId");
            this._ordinal2DishCourseId = reader.GetOrdinal("DishCourseId");
            this._ordinal2DishOccasionId = reader.GetOrdinal("DishOccasionId");
            this._ordinal2DishWorldId = reader.GetOrdinal("DishWorldId");
            this._ordinal2DishServingMask = reader.GetOrdinal("DishServingMask");
            this._ordinal2DishCookingMethodId = reader.GetOrdinal("DishCookingMethodId");
            this._ordinal2SeasonMask = reader.GetOrdinal("SeasonMask");
            this._ordinal2ServiceRequestTypeMask = reader.GetOrdinal("ServiceRequestTypeMask");
            this._ordinal2ServingAmount = reader.GetOrdinal("ServingAmount");
            this._initialized2 = true;
        }
        protected override void BindListResultToItem(MasterMenuView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (MasterMenuState)reader.GetByte(this._ordinal2State);
            ...
            if(reader.IsDBNull(_ordinal2DishIngredientId)) item.DishIngredientId = null; else item.DishIngredientId = reader.GetInt32(this._ordinal2DishIngredientId);
            if(reader.IsDBNull(_ordinal2DishTypeId)) item.DishTypeId = null; else item.DishTypeId = reader.GetInt32(this._ordinal2DishTypeId);
            if(reader.IsDBNull(_ordinal2DishSubtypeId)) item.DishSubtypeId = null; else item.DishSubtypeId = reader.GetInt32(this._ordinal2DishSubtypeId);
            if(reader.IsDBNull(_ordinal2DishCourseId)) item.DishCourseId = null; else item.DishCourseId = reader.GetInt32(this._ordinal2DishCourseId);
            if(reader.IsDBNull(_ordinal2DishOccasionId)) item.DishOccasionId = null; else item.DishOccasionId = reader.GetInt32(this._ordinal2DishOccasionId);
            if(reader.IsDBNull(_ordinal2DishWorldId)) item.DishWorldId = null; else item.DishWorldId = reader.GetInt32(this._ordinal2DishWorldId);
            if(reader.IsDBNull(_ordinal2DishServingMask)) item.DishServingMask = null; else item.DishServingMask = reader.GetInt32(this._ordinal2DishServingMask);
            if(reader.IsDBNull(_ordinal2DishCookingMethodId)) item.DishCookingMethodId = null; else item.DishCookingMethodId = reader.GetInt32(this._ordinal2DishCookingMethodId);
            if(reader.IsDBNull(_ordinal2SeasonMask)) item.SeasonMask = null; else item.SeasonMask = reader.GetInt32(this._ordinal2SeasonMask);
            if(reader.IsDBNull(_ordinal2ServiceRequestTypeMask)) item.ServiceRequestTypeMask = null; else item.ServiceRequestTypeMask = reader.GetInt32(this._ordinal2ServiceRequestTypeMask);
            if(reader.IsDBNull(_ordinal2ServingAmount)) item.ServingAmount = null; else item.ServingAmount = reader.GetDecimal(this._ordinal2ServingAmount);
        }
    }
}
