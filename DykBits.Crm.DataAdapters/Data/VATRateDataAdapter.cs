...
namespace DykBits.Crm.Data
{
    ...
    public partial class VATRateDataAdapter : XmlDataAdapterBase<VATRateView, VATRate, VATRateFilter>
    {
        ...
        protected override void BindBrowseResultToItem(VATRateView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (VATRateState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(VATRateView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (VATRateState)reader.GetByte(this._ordinal2State);
