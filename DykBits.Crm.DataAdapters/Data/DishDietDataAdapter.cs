...
namespace DykBits.Crm.Data
{
    ...
    public partial class DishDietDataAdapter : XmlDataAdapterBase<DishDietView, DishDiet, DishDietFilter>
    {
        ...
        protected override void BindBrowseResultToItem(DishDietView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (DishDietState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(DishDietView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (DishDietState)reader.GetByte(this._ordinal2State);
