...
namespace DykBits.Crm.Data
{
    ...
    public partial class DishServingDataAdapter : XmlDataAdapterBase<DishServingView, DishServing, DishServingFilter>
    {
        ...
        protected override void BindBrowseResultToItem(DishServingView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (DishServingState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(DishServingView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (DishServingState)reader.GetByte(this._ordinal2State);
