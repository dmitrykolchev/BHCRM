...
namespace DykBits.Crm.Data
{
    ...
    public partial class ServiceLevelDataAdapter : DataAdapterBase<ServiceLevelView, ServiceLevel, ServiceLevelFilter>
    {
        ...
        protected override void BindBrowseResultToItem(ServiceLevelView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ServiceLevelState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(ServiceLevelView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ServiceLevelState)reader.GetByte(this._ordinal2State);
        ...
        protected override void BindGetItemResultToItem(ServiceLevel item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (ServiceLevelState)reader.GetByte(this._ordinal0State);
        ...
        protected override void BindCreateCommand(SqlCommand command, ServiceLevel item)
        {
        ...
        protected override void BindUpdateCommand(SqlCommand command, ServiceLevel item)
        {
