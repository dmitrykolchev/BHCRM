...
namespace DykBits.Crm.Data
{
    ...
    public partial class DishWorldDataAdapter : XmlDataAdapterBase<DishWorldView, DishWorld, DishWorldFilter>
    {
        ...
        protected override void BindBrowseResultToItem(DishWorldView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (DishWorldState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(DishWorldView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (DishWorldState)reader.GetByte(this._ordinal2State);
