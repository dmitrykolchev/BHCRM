...
namespace DykBits.Crm.Data
{
    ...
    public partial class ProductTypeDataAdapter : DataAdapterBase<ProductTypeView, ProductType, ProductTypeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(ProductTypeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ProductTypeState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(ProductTypeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ProductTypeState)reader.GetByte(this._ordinal2State);
        ...
        protected override void BindGetItemResultToItem(ProductType item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (ProductTypeState)reader.GetByte(this._ordinal0State);
        ...
        protected override void BindCreateCommand(SqlCommand command, ProductType item)
        {
        ...
        protected override void BindUpdateCommand(SqlCommand command, ProductType item)
        {
