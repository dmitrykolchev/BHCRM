...
namespace DykBits.Crm.Data
{
    ...
    public partial class ProductCostStatementDataAdapter : XmlDataAdapterBase<ProductCostStatementView, ProductCostStatement, ProductCostStatementFilter>
    {
        ...
        protected override void BindBrowseResultToItem(ProductCostStatementView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ProductCostStatementState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(ProductCostStatementView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ProductCostStatementState)reader.GetByte(this._ordinal2State);
