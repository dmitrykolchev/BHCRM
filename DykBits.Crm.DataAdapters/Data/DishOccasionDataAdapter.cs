...
namespace DykBits.Crm.Data
{
    ...
    public partial class DishOccasionDataAdapter : XmlDataAdapterBase<DishOccasionView, DishOccasion, DishOccasionFilter>
    {
        ...
        protected override void BindBrowseResultToItem(DishOccasionView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (DishOccasionState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(DishOccasionView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (DishOccasionState)reader.GetByte(this._ordinal2State);
