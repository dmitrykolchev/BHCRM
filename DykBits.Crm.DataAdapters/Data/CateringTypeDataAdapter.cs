...
namespace DykBits.Crm.Data
{
    ...
    public partial class CateringTypeDataAdapter : XmlDataAdapterBase<CateringTypeView, CateringType, CateringTypeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(CateringTypeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (CateringTypeState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(CateringTypeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (CateringTypeState)reader.GetByte(this._ordinal2State);
