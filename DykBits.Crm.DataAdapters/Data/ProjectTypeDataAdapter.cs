...
namespace DykBits.Crm.Data
{
    ...
    public partial class ProjectTypeDataAdapter : DataAdapterBase<ProjectTypeView, ProjectType, ProjectTypeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(ProjectTypeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ProjectTypeState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(ProjectTypeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ProjectTypeState)reader.GetByte(this._ordinal2State);
        ...
        protected override void BindGetItemResultToItem(ProjectType item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (ProjectTypeState)reader.GetByte(this._ordinal0State);
        ...
        protected override void BindCreateCommand(SqlCommand command, ProjectType item)
        {
        ...
        protected override void BindUpdateCommand(SqlCommand command, ProjectType item)
        {
