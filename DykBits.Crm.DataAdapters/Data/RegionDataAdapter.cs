...
namespace DykBits.Crm.Data
{
    ...
    public partial class RegionDataAdapter : DataAdapterBase<RegionView, Region, RegionFilter>
    {
        ...
        protected override void BindBrowseResultToItem(RegionView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (RegionState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(RegionView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (RegionState)reader.GetByte(this._ordinal2State);
        ...
        protected override void BindGetItemResultToItem(Region item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (RegionState)reader.GetByte(this._ordinal0State);
        ...
        protected override void BindCreateCommand(SqlCommand command, Region item)
        {
        ...
        protected override void BindUpdateCommand(SqlCommand command, Region item)
        {
