...
namespace DykBits.Crm.Data
{
    ...
    public partial class OperatingBudgetDataAdapter : XmlDataAdapterBase<OperatingBudgetView, OperatingBudget, OperatingBudgetFilter>
    {
        ...
        protected override void BindBrowseResultToItem(OperatingBudgetView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (OperatingBudgetState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(OperatingBudgetView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (OperatingBudgetState)reader.GetByte(this._ordinal2State);
