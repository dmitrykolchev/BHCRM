...
namespace DykBits.Crm.Data
{
    ...
    public partial class ContactGroupDataAdapter : XmlDataAdapterBase<ContactGroupView, ContactGroup, ContactGroupFilter>
    {
        ...
        protected override void BindBrowseResultToItem(ContactGroupView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ContactGroupState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(ContactGroupView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ContactGroupState)reader.GetByte(this._ordinal2State);
