...
namespace DykBits.Crm.Data
{
    ...
    public partial class ProjectTaskStatusDataAdapter : XmlDataAdapterBase<ProjectTaskStatusView, ProjectTaskStatus, ProjectTaskStatusFilter>
    {
        ...
        private int _ordinal1ProjectTaskState;
        ...
        private void InitializeBindBrowseResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal1ProjectTaskState = reader.GetOrdinal("ProjectTaskState");
        ...
        protected override void BindBrowseResultToItem(ProjectTaskStatusView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ProjectTaskStatusState)reader.GetByte(this._ordinal1State);
            item.FileAs = reader.GetString(this._ordinal1FileAs);
            item.Color = reader.GetInt32(this._ordinal1Color);
            item.Complete = reader.GetDecimal(this._ordinal1Complete);
            item.ProjectTaskState = reader.GetByte(this._ordinal1ProjectTaskState);
        ...
        private int _ordinal2Color;
        private int _ordinal2Complete;
        private int _ordinal2ProjectTaskState;
        private void InitializeBindListResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal2Color = reader.GetOrdinal("Color");
            this._ordinal2Complete = reader.GetOrdinal("Complete");
            this._ordinal2ProjectTaskState = reader.GetOrdinal("ProjectTaskState");
            this._initialized2 = true;
        }
        protected override void BindListResultToItem(ProjectTaskStatusView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ProjectTaskStatusState)reader.GetByte(this._ordinal2State);
            item.FileAs = reader.GetString(this._ordinal2FileAs);
            item.Color = reader.GetInt32(this._ordinal2Color);
            item.Complete = reader.GetDecimal(this._ordinal2Complete);
            item.ProjectTaskState = reader.GetByte(this._ordinal2ProjectTaskState);
        }
    }
}
