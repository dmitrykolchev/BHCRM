...
namespace DykBits.Crm.Data
{
    ...
    public partial class VenuePlaceDataAdapter : XmlDataAdapterBase<VenuePlaceView, VenuePlace, VenuePlaceFilter>
    {
        ...
        protected override void BindBrowseResultToItem(VenuePlaceView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (VenuePlaceState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(VenuePlaceView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (VenuePlaceState)reader.GetByte(this._ordinal2State);
