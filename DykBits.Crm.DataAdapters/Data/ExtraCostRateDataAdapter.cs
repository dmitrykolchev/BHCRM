...
namespace DykBits.Crm.Data
{
    ...
    public partial class ExtraCostRateDataAdapter : XmlDataAdapterBase<ExtraCostRateView, ExtraCostRate, ExtraCostRateFilter>
    {
        ...
        private int _ordinal1IsDefault;
        ...
        private void InitializeBindBrowseResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal1IsDefault = reader.GetOrdinal("IsDefault");
        ...
        protected override void BindBrowseResultToItem(ExtraCostRateView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ExtraCostRateState)reader.GetByte(this._ordinal1State);
            item.FileAs = reader.GetString(this._ordinal1FileAs);
            item.Value = reader.GetDecimal(this._ordinal1Value);
            item.IsDefault = reader.GetBoolean(this._ordinal1IsDefault);
        ...
        private int _ordinal2IsDefault;
        private void InitializeBindListResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal2IsDefault = reader.GetOrdinal("IsDefault");
            this._initialized2 = true;
        }
        protected override void BindListResultToItem(ExtraCostRateView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ExtraCostRateState)reader.GetByte(this._ordinal2State);
            item.FileAs = reader.GetString(this._ordinal2FileAs);
            item.Value = reader.GetDecimal(this._ordinal2Value);
            item.IsDefault = reader.GetBoolean(this._ordinal2IsDefault);
        }
    }
}
