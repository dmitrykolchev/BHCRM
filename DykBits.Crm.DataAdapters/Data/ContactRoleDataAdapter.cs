...
namespace DykBits.Crm.Data
{
    ...
    public partial class ContactRoleDataAdapter : XmlDataAdapterBase<ContactRoleView, ContactRole, ContactRoleFilter>
    {
        ...
        protected override void BindBrowseResultToItem(ContactRoleView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ContactRoleState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(ContactRoleView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ContactRoleState)reader.GetByte(this._ordinal2State);
