...
namespace DykBits.Crm.Data
{
    ...
    public partial class AccessRightDataAdapter : XmlDataAdapterBase<AccessRightView, AccessRight, AccessRightFilter>
    {
        ...
        protected override void BindBrowseResultToItem(AccessRightView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (AccessRightState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(AccessRightView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (AccessRightState)reader.GetByte(this._ordinal2State);
