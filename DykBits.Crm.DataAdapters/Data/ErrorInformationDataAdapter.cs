...
namespace DykBits.Crm.Data
{
    ...
    public partial class ErrorInformationDataAdapter : XmlDataAdapterBase<ErrorInformationView, ErrorInformation, ErrorInformationFilter>
    {
        ...
        protected override void BindBrowseResultToItem(ErrorInformationView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ErrorInformationState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(ErrorInformationView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ErrorInformationState)reader.GetByte(this._ordinal2State);
