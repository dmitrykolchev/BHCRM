...
namespace DykBits.Crm.Data
{
    ...
    public partial class EstimatesTemplateDataAdapter : XmlDataAdapterBase<EstimatesTemplateView, EstimatesTemplate, EstimatesTemplateFilter>
    {
        ...
        protected override void BindBrowseResultToItem(EstimatesTemplateView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (EstimatesTemplateState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(EstimatesTemplateView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (EstimatesTemplateState)reader.GetByte(this._ordinal2State);
