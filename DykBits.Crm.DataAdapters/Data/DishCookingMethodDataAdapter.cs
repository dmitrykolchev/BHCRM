...
namespace DykBits.Crm.Data
{
    ...
    public partial class DishCookingMethodDataAdapter : XmlDataAdapterBase<DishCookingMethodView, DishCookingMethod, DishCookingMethodFilter>
    {
        ...
        protected override void BindBrowseResultToItem(DishCookingMethodView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (DishCookingMethodState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(DishCookingMethodView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (DishCookingMethodState)reader.GetByte(this._ordinal2State);
