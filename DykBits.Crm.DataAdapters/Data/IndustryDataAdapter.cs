...
namespace DykBits.Crm.Data
{
    ...
    public partial class IndustryDataAdapter : DataAdapterBase<IndustryView, Industry, IndustryFilter>
    {
        ...
        protected override void BindBrowseResultToItem(IndustryView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (IndustryState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(IndustryView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (IndustryState)reader.GetByte(this._ordinal2State);
        ...
        protected override void BindGetItemResultToItem(Industry item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (IndustryState)reader.GetByte(this._ordinal0State);
        ...
        protected override void BindCreateCommand(SqlCommand command, Industry item)
        {
        ...
        protected override void BindUpdateCommand(SqlCommand command, Industry item)
        {
