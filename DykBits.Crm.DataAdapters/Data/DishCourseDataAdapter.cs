...
namespace DykBits.Crm.Data
{
    ...
    public partial class DishCourseDataAdapter : XmlDataAdapterBase<DishCourseView, DishCourse, DishCourseFilter>
    {
        ...
        protected override void BindBrowseResultToItem(DishCourseView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (DishCourseState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(DishCourseView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (DishCourseState)reader.GetByte(this._ordinal2State);
