...
namespace DykBits.Crm.Data
{
    ...
    public partial class ProductCategoryDataAdapter : DataAdapterBase<ProductCategoryView, ProductCategory, ProductCategoryFilter>
    {
        ...
        protected override void BindBrowseResultToItem(ProductCategoryView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ProductCategoryState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(ProductCategoryView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ProductCategoryState)reader.GetByte(this._ordinal2State);
        ...
        protected override void BindGetItemResultToItem(ProductCategory item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (ProductCategoryState)reader.GetByte(this._ordinal0State);
        ...
        protected override void BindCreateCommand(SqlCommand command, ProductCategory item)
        {
        ...
        protected override void BindUpdateCommand(SqlCommand command, ProductCategory item)
        {
