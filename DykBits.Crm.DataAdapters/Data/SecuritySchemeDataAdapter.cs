...
namespace DykBits.Crm.Data
{
    ...
    public partial class SecuritySchemeDataAdapter : XmlDataAdapterBase<SecuritySchemeView, SecurityScheme, SecuritySchemeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(SecuritySchemeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (SecuritySchemeState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(SecuritySchemeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (SecuritySchemeState)reader.GetByte(this._ordinal2State);
