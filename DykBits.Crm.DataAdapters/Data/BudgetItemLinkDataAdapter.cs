...
namespace DykBits.Crm.Data
{
    ...
    public partial class BudgetItemLinkDataAdapter : XmlDataAdapterBase<BudgetItemLinkView, BudgetItemLink, BudgetItemLinkFilter>
    {
        ...
        protected override void BindBrowseResultToItem(BudgetItemLinkView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (BudgetItemLinkState)reader.GetByte(this._ordinal1State);
            item.FileAs = reader.GetString(this._ordinal1FileAs);
            item.IncomeBudgetItemId = reader.GetInt32(this._ordinal1IncomeBudgetItemId);
            item.ExpenseBudgetItemId = reader.GetInt32(this._ordinal1ExpenseBudgetItemId);
        ...
        protected override void BindListResultToItem(BudgetItemLinkView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (BudgetItemLinkState)reader.GetByte(this._ordinal2State);
            item.FileAs = reader.GetString(this._ordinal2FileAs);
            item.IncomeBudgetItemId = reader.GetInt32(this._ordinal2IncomeBudgetItemId);
            item.ExpenseBudgetItemId = reader.GetInt32(this._ordinal2ExpenseBudgetItemId);
        }
    }
}
