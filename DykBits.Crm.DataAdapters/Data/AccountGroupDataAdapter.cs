...
namespace DykBits.Crm.Data
{
    ...
    public partial class AccountGroupDataAdapter : XmlDataAdapterBase<AccountGroupView, AccountGroup, AccountGroupFilter>
    {
        ...
        protected override void BindBrowseResultToItem(AccountGroupView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (AccountGroupState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(AccountGroupView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (AccountGroupState)reader.GetByte(this._ordinal2State);
