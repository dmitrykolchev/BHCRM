...
namespace DykBits.Crm.Data
{
    ...
    public partial class TradeMarkDataAdapter : XmlDataAdapterBase<TradeMarkView, TradeMark, TradeMarkFilter>
    {
        private bool _initialized1;
        private int _ordinal1Id;
        private int _ordinal1State;
        private int _ordinal1FileAs;
        private int _ordinal1BusinessActivityTypeId;
        ...
        private void InitializeBindBrowseResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal1BusinessActivityTypeId = reader.GetOrdinal("BusinessActivityTypeId");
        ...
        protected override void BindBrowseResultToItem(TradeMarkView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (TradeMarkState)reader.GetByte(this._ordinal1State);
            item.FileAs = reader.GetString(this._ordinal1FileAs);
            item.BusinessActivityTypeId = reader.GetInt32(this._ordinal1BusinessActivityTypeId);
        ...
        private int _ordinal2BusinessActivityTypeId;
        ...
        private void InitializeBindListResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal2BusinessActivityTypeId = reader.GetOrdinal("BusinessActivityTypeId");
            this._ordinal2OrganizationId = reader.GetOrdinal("OrganizationId");
            this._initialized2 = true;
        }
        protected override void BindListResultToItem(TradeMarkView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (TradeMarkState)reader.GetByte(this._ordinal2State);
            item.FileAs = reader.GetString(this._ordinal2FileAs);
            item.BusinessActivityTypeId = reader.GetInt32(this._ordinal2BusinessActivityTypeId);
