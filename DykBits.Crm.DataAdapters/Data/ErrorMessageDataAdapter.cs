...
namespace DykBits.Crm.Data
{
    ...
    public partial class ErrorMessageDataAdapter : XmlDataAdapterBase<ErrorMessageView, ErrorMessage, ErrorMessageFilter>
    {
        ...
        protected override void BindBrowseResultToItem(ErrorMessageView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ErrorMessageState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(ErrorMessageView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ErrorMessageState)reader.GetByte(this._ordinal2State);
