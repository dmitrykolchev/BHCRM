...
namespace DykBits.Crm.Data
{
    ...
    public partial class StoragePlaceDataAdapter : XmlDataAdapterBase<StoragePlaceView, StoragePlace, StoragePlaceFilter>
    {
        ...
        protected override void BindBrowseResultToItem(StoragePlaceView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (StoragePlaceState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(StoragePlaceView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (StoragePlaceState)reader.GetByte(this._ordinal2State);
