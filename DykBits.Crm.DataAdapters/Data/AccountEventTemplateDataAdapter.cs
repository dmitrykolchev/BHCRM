...
namespace DykBits.Crm.Data
{
    ...
    public partial class AccountEventTemplateDataAdapter : XmlDataAdapterBase<AccountEventTemplateView, AccountEventTemplate, AccountEventTemplateFilter>
    {
        ...
        protected override void BindBrowseResultToItem(AccountEventTemplateView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (AccountEventTemplateState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(AccountEventTemplateView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (AccountEventTemplateState)reader.GetByte(this._ordinal2State);
