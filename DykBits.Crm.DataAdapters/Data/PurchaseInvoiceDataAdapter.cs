...
namespace DykBits.Crm.Data
{
    ...
    public partial class PurchaseInvoiceDataAdapter : XmlDataAdapterBase<PurchaseInvoiceView, PurchaseInvoice, PurchaseInvoiceFilter>
    {
        ...
        private int _ordinal1OperatingBudgetDocumentDate;
        ...
        private void InitializeBindBrowseResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal1OperatingBudgetDocumentDate = reader.GetOrdinal("OperatingBudgetDocumentDate");
        ...
        protected override void BindBrowseResultToItem(PurchaseInvoiceView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (PurchaseInvoiceState)reader.GetByte(this._ordinal1State);
            ...
            if(reader.IsDBNull(_ordinal1DueDate)) item.DueDate = null; else item.DueDate = reader.GetDateTime(this._ordinal1DueDate);
            ...
            if(reader.IsDBNull(_ordinal1OperatingBudgetDocumentDate)) item.OperatingBudgetDocumentDate = null; else item.OperatingBudgetDocumentDate = reader.GetDateTime(this._ordinal1OperatingBudgetDocumentDate);
        ...
        protected override void BindListResultToItem(PurchaseInvoiceView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (PurchaseInvoiceState)reader.GetByte(this._ordinal2State);
            ...
            if(reader.IsDBNull(_ordinal2DueDate)) item.DueDate = null; else item.DueDate = reader.GetDateTime(this._ordinal2DueDate);
