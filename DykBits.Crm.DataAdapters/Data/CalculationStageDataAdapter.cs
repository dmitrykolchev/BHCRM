...
namespace DykBits.Crm.Data
{
    ...
    public partial class CalculationStageDataAdapter : XmlDataAdapterBase<CalculationStageView, CalculationStage, CalculationStageFilter>
    {
        ...
        protected override void BindBrowseResultToItem(CalculationStageView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (CalculationStageState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(CalculationStageView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (CalculationStageState)reader.GetByte(this._ordinal2State);
