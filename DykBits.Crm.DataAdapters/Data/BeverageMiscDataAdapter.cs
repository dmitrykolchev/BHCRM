...
namespace DykBits.Crm.Data
{
    ...
    public partial class BeverageMiscDataAdapter : XmlDataAdapterBase<BeverageMiscView, BeverageMisc, BeverageMiscFilter>
    {
        ...
        protected override void BindBrowseResultToItem(BeverageMiscView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (BeverageMiscState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(BeverageMiscView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (BeverageMiscState)reader.GetByte(this._ordinal2State);
