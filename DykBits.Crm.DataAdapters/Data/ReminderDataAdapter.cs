...
namespace DykBits.Crm.Data
{
    ...
    public partial class ReminderDataAdapter : XmlDataAdapterBase<ReminderView, Reminder, ReminderFilter>
    {
        ...
        private int _ordinal1ReminderTime;
        ...
        private void InitializeBindBrowseResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal1ReminderTime = reader.GetOrdinal("ReminderTime");
        ...
        protected override void BindBrowseResultToItem(ReminderView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ReminderState)reader.GetByte(this._ordinal1State);
            ...
            item.ReminderTime = reader.GetDateTime(this._ordinal1ReminderTime);
            item.UserId = reader.GetInt32(this._ordinal1UserId);
            ...
            if(reader.IsDBNull(_ordinal1DocumentId)) item.DocumentId = null; else item.DocumentId = reader.GetInt32(this._ordinal1DocumentId);
        ...
        private int _ordinal2ReminderTime;
        ...
        private void InitializeBindListResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal2ReminderTime = reader.GetOrdinal("ReminderTime");
        ...
        protected override void BindListResultToItem(ReminderView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ReminderState)reader.GetByte(this._ordinal2State);
            ...
            item.ReminderTime = reader.GetDateTime(this._ordinal2ReminderTime);
            item.UserId = reader.GetInt32(this._ordinal2UserId);
            ...
            if(reader.IsDBNull(_ordinal2DocumentId)) item.DocumentId = null; else item.DocumentId = reader.GetInt32(this._ordinal2DocumentId);
        }
    }
}
