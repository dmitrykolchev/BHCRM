...
namespace DykBits.Crm.Data
{
    ...
    public partial class InventoryStatementDataAdapter : XmlDataAdapterBase<InventoryStatementView, InventoryStatement, InventoryStatementFilter>
    {
        ...
        protected override void BindBrowseResultToItem(InventoryStatementView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (InventoryStatementState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(InventoryStatementView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (InventoryStatementState)reader.GetByte(this._ordinal2State);
