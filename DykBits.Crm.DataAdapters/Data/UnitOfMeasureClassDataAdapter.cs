...
namespace DykBits.Crm.Data
{
    ...
    public partial class UnitOfMeasureClassDataAdapter : DataAdapterBase<UnitOfMeasureClassView, UnitOfMeasureClass, UnitOfMeasureClassFilter>
    {
        private bool _initialized1;
        private int _ordinal1Id;
        private int _ordinal1State;
        private int _ordinal1FileAs;
        private int _ordinal1BaseUnitOfMeasureId;
        ...
        private void InitializeBindBrowseResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal1BaseUnitOfMeasureId = reader.GetOrdinal("BaseUnitOfMeasureId");
        ...
        protected override void BindBrowseResultToItem(UnitOfMeasureClassView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (UnitOfMeasureClassState)reader.GetByte(this._ordinal1State);
            item.FileAs = reader.GetString(this._ordinal1FileAs);
            if(reader.IsDBNull(_ordinal1BaseUnitOfMeasureId)) item.BaseUnitOfMeasureId = null; else item.BaseUnitOfMeasureId = reader.GetInt32(this._ordinal1BaseUnitOfMeasureId);
        ...
        private int _ordinal2BaseUnitOfMeasureId;
        private void InitializeBindListResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal2BaseUnitOfMeasureId = reader.GetOrdinal("BaseUnitOfMeasureId");
            this._initialized2 = true;
        }
        protected override void BindListResultToItem(UnitOfMeasureClassView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (UnitOfMeasureClassState)reader.GetByte(this._ordinal2State);
            item.FileAs = reader.GetString(this._ordinal2FileAs);
            if(reader.IsDBNull(_ordinal2BaseUnitOfMeasureId)) item.BaseUnitOfMeasureId = null; else item.BaseUnitOfMeasureId = reader.GetInt32(this._ordinal2BaseUnitOfMeasureId);
        }
        private bool _initialized0;
        private int _ordinal0Id;
        private int _ordinal0State;
        private int _ordinal0FileAs;
        private int _ordinal0BaseUnitOfMeasureId;
        ...
        private void InitializeBindGetItemResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal0BaseUnitOfMeasureId = reader.GetOrdinal("BaseUnitOfMeasureId");
        ...
        protected override void BindGetItemResultToItem(UnitOfMeasureClass item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (UnitOfMeasureClassState)reader.GetByte(this._ordinal0State);
            item.FileAs = reader.GetString(this._ordinal0FileAs);
            if(reader.IsDBNull(_ordinal0BaseUnitOfMeasureId)) item.BaseUnitOfMeasureId = null; else item.BaseUnitOfMeasureId = reader.GetInt32(this._ordinal0BaseUnitOfMeasureId);
        ...
        protected override void BindCreateCommand(SqlCommand command, UnitOfMeasureClass item)
        {
            command.Parameters["@FileAs"].Value = DbValueConverter.Convert(item.FileAs);
            command.Parameters["@BaseUnitOfMeasureId"].Value = DbValueConverter.Convert(item.BaseUnitOfMeasureId);
            command.Parameters["@Comments"].Value = DbValueConverter.Convert(item.Comments);
        }
        protected override void BindUpdateCommand(SqlCommand command, UnitOfMeasureClass item)
        {
