...
namespace DykBits.Crm.Data
{
    ...
    public partial class BudgetItemGroupDataAdapter : XmlDataAdapterBase<BudgetItemGroupView, BudgetItemGroup, BudgetItemGroupFilter>
    {
        ...
        protected override void BindBrowseResultToItem(BudgetItemGroupView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (BudgetItemGroupState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(BudgetItemGroupView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (BudgetItemGroupState)reader.GetByte(this._ordinal2State);
