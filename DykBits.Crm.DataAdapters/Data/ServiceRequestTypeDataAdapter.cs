...
namespace DykBits.Crm.Data
{
    ...
    public partial class ServiceRequestTypeDataAdapter : XmlDataAdapterBase<ServiceRequestTypeView, ServiceRequestType, ServiceRequestTypeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(ServiceRequestTypeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ServiceRequestTypeState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(ServiceRequestTypeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ServiceRequestTypeState)reader.GetByte(this._ordinal2State);
