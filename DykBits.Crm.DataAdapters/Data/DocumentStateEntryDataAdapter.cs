...
namespace DykBits.Crm.Data
{
    ...
    public partial class DocumentStateEntryDataAdapter : XmlDataAdapterBase<DocumentStateEntryView, DocumentStateEntry, DocumentStateEntryFilter>
    {
        ...
        private int _ordinal1OverlayImage;
        ...
        private void InitializeBindBrowseResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal1OverlayImage = reader.GetOrdinal("OverlayImage");
        ...
        protected override void BindBrowseResultToItem(DocumentStateEntryView item, SqlDataReader reader)
        {
            ...
            item.State = (DocumentStateEntryState)reader.GetByte(this._ordinal1State);
            item.OrdinalPosition = reader.GetInt32(this._ordinal1OrdinalPosition);
            item.Value = reader.GetByte(this._ordinal1Value);
            item.Code = reader.GetString(this._ordinal1Code);
            item.FileAs = reader.GetString(this._ordinal1FileAs);
            if(reader.IsDBNull(_ordinal1OverlayImage)) item.OverlayImage = null; else item.OverlayImage = reader.GetSqlBinary(this._ordinal1OverlayImage).Value;
        ...
        private int _ordinal2OverlayImage;
        private void InitializeBindListResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal2OverlayImage = reader.GetOrdinal("OverlayImage");
            this._initialized2 = true;
        }
        protected override void BindListResultToItem(DocumentStateEntryView item, SqlDataReader reader)
        {
            ...
            item.State = (DocumentStateEntryState)reader.GetByte(this._ordinal2State);
            item.OrdinalPosition = reader.GetInt32(this._ordinal2OrdinalPosition);
            item.Value = reader.GetByte(this._ordinal2Value);
            item.Code = reader.GetString(this._ordinal2Code);
            item.FileAs = reader.GetString(this._ordinal2FileAs);
            if(reader.IsDBNull(_ordinal2OverlayImage)) item.OverlayImage = null; else item.OverlayImage = reader.GetSqlBinary(this._ordinal2OverlayImage).Value;
        }
    }
}
