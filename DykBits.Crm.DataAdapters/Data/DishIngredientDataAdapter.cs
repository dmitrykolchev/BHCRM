...
namespace DykBits.Crm.Data
{
    ...
    public partial class DishIngredientDataAdapter : XmlDataAdapterBase<DishIngredientView, DishIngredient, DishIngredientFilter>
    {
        ...
        protected override void BindBrowseResultToItem(DishIngredientView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (DishIngredientState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(DishIngredientView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (DishIngredientState)reader.GetByte(this._ordinal2State);
