...
namespace DykBits.Crm.Data
{
    ...
    public partial class DishTypeDataAdapter : XmlDataAdapterBase<DishTypeView, DishType, DishTypeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(DishTypeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (DishTypeState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(DishTypeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (DishTypeState)reader.GetByte(this._ordinal2State);
