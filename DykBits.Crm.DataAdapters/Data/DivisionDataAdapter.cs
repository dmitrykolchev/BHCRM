...
namespace DykBits.Crm.Data
{
    ...
    public partial class DivisionDataAdapter : DataAdapterBase<DivisionView, Division, DivisionFilter>
    {
        ...
        private int _ordinal1HeadOfDivisionId;
        ...
        private void InitializeBindBrowseResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal1HeadOfDivisionId = reader.GetOrdinal("HeadOfDivisionId");
        ...
        protected override void BindBrowseResultToItem(DivisionView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (DivisionState)reader.GetByte(this._ordinal1State);
            item.FileAs = reader.GetString(this._ordinal1FileAs);
            item.AccountId = reader.GetInt32(this._ordinal1AccountId);
            if(reader.IsDBNull(_ordinal1HeadOfDivisionId)) item.HeadOfDivisionId = null; else item.HeadOfDivisionId = reader.GetInt32(this._ordinal1HeadOfDivisionId);
        ...
        private int _ordinal2HeadOfDivisionId;
        private void InitializeBindListResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal2HeadOfDivisionId = reader.GetOrdinal("HeadOfDivisionId");
            this._initialized2 = true;
        }
        protected override void BindListResultToItem(DivisionView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (DivisionState)reader.GetByte(this._ordinal2State);
            item.FileAs = reader.GetString(this._ordinal2FileAs);
            item.AccountId = reader.GetInt32(this._ordinal2AccountId);
            if(reader.IsDBNull(_ordinal2HeadOfDivisionId)) item.HeadOfDivisionId = null; else item.HeadOfDivisionId = reader.GetInt32(this._ordinal2HeadOfDivisionId);
        }
        ...
        private int _ordinal0HeadOfDivisionId;
        ...
        private void InitializeBindGetItemResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal0HeadOfDivisionId = reader.GetOrdinal("HeadOfDivisionId");
        ...
        protected override void BindGetItemResultToItem(Division item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (DivisionState)reader.GetByte(this._ordinal0State);
            item.FileAs = reader.GetString(this._ordinal0FileAs);
            item.AccountId = reader.GetInt32(this._ordinal0AccountId);
            if(reader.IsDBNull(_ordinal0HeadOfDivisionId)) item.HeadOfDivisionId = null; else item.HeadOfDivisionId = reader.GetInt32(this._ordinal0HeadOfDivisionId);
        ...
        protected override void BindCreateCommand(SqlCommand command, Division item)
        {
            command.Parameters["@FileAs"].Value = DbValueConverter.Convert(item.FileAs);
            command.Parameters["@AccountId"].Value = item.AccountId;
            command.Parameters["@HeadOfDivisionId"].Value = DbValueConverter.Convert(item.HeadOfDivisionId);
            command.Parameters["@Comments"].Value = DbValueConverter.Convert(item.Comments);
        }
        protected override void BindUpdateCommand(SqlCommand command, Division item)
        {
