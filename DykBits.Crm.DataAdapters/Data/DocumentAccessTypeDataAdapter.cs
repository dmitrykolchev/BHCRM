...
namespace DykBits.Crm.Data
{
    ...
    public partial class DocumentAccessTypeDataAdapter : XmlDataAdapterBase<DocumentAccessTypeView, DocumentAccessType, DocumentAccessTypeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(DocumentAccessTypeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (DocumentAccessTypeState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(DocumentAccessTypeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (DocumentAccessTypeState)reader.GetByte(this._ordinal2State);
