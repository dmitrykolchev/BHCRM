...
namespace DykBits.Crm.Data
{
    ...
    public partial class AbstractProductDataAdapter : DataAdapterBase<AbstractProductView, AbstractProduct, AbstractProductFilter>
    {
        ...
        protected override void BindBrowseResultToItem(AbstractProductView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (AbstractProductState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(AbstractProductView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (AbstractProductState)reader.GetByte(this._ordinal2State);
        ...
        private int _ordinal0FullName;
        private int _ordinal0ProductTypeId;
        private int _ordinal0ProductCategoryId;
        private int _ordinal0ProductSubcategoryId;
        private int _ordinal0UnitOfMeasureId;
        ...
        private void InitializeBindGetItemResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal0FullName = reader.GetOrdinal("FullName");
            this._ordinal0ProductTypeId = reader.GetOrdinal("ProductTypeId");
            this._ordinal0ProductCategoryId = reader.GetOrdinal("ProductCategoryId");
            this._ordinal0ProductSubcategoryId = reader.GetOrdinal("ProductSubcategoryId");
            this._ordinal0UnitOfMeasureId = reader.GetOrdinal("UnitOfMeasureId");
        ...
        protected override void BindGetItemResultToItem(AbstractProduct item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (AbstractProductState)reader.GetByte(this._ordinal0State);
            item.FileAs = reader.GetString(this._ordinal0FileAs);
            if(reader.IsDBNull(_ordinal0FullName)) item.FullName = null; else item.FullName = reader.GetString(this._ordinal0FullName);
            item.ProductTypeId = reader.GetInt32(this._ordinal0ProductTypeId);
            item.ProductCategoryId = reader.GetInt32(this._ordinal0ProductCategoryId);
            if(reader.IsDBNull(_ordinal0ProductSubcategoryId)) item.ProductSubcategoryId = null; else item.ProductSubcategoryId = reader.GetInt32(this._ordinal0ProductSubcategoryId);
            item.UnitOfMeasureId = reader.GetInt32(this._ordinal0UnitOfMeasureId);
        ...
        protected override void BindCreateCommand(SqlCommand command, AbstractProduct item)
        {
            command.Parameters["@FileAs"].Value = DbValueConverter.Convert(item.FileAs);
            command.Parameters["@FullName"].Value = DbValueConverter.Convert(item.FullName);
            command.Parameters["@ProductTypeId"].Value = item.ProductTypeId;
            command.Parameters["@ProductCategoryId"].Value = item.ProductCategoryId;
            command.Parameters["@ProductSubcategoryId"].Value = DbValueConverter.Convert(item.ProductSubcategoryId);
            command.Parameters["@UnitOfMeasureId"].Value = item.UnitOfMeasureId;
            command.Parameters["@Comments"].Value = DbValueConverter.Convert(item.Comments);
        }
        protected override void BindUpdateCommand(SqlCommand command, AbstractProduct item)
        {
