...
namespace DykBits.Crm.Data
{
    ...
    public partial class ProductSubcategoryDataAdapter : DataAdapterBase<ProductSubcategoryView, ProductSubcategory, ProductSubcategoryFilter>
    {
        ...
        protected override void BindBrowseResultToItem(ProductSubcategoryView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ProductSubcategoryState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(ProductSubcategoryView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ProductSubcategoryState)reader.GetByte(this._ordinal2State);
        ...
        protected override void BindGetItemResultToItem(ProductSubcategory item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (ProductSubcategoryState)reader.GetByte(this._ordinal0State);
        ...
        protected override void BindCreateCommand(SqlCommand command, ProductSubcategory item)
        {
        ...
        protected override void BindUpdateCommand(SqlCommand command, ProductSubcategory item)
        {
