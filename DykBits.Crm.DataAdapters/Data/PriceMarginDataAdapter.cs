...
namespace DykBits.Crm.Data
{
    ...
    public partial class PriceMarginDataAdapter : XmlDataAdapterBase<PriceMarginView, PriceMargin, PriceMarginFilter>
    {
        ...
        protected override void BindBrowseResultToItem(PriceMarginView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (PriceMarginState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(PriceMarginView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (PriceMarginState)reader.GetByte(this._ordinal2State);
