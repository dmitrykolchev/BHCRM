...
namespace DykBits.Crm.Data
{
    ...
    public partial class TaxRateDataAdapter : XmlDataAdapterBase<TaxRateView, TaxRate, TaxRateFilter>
    {
        ...
        protected override void BindBrowseResultToItem(TaxRateView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (TaxRateState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(TaxRateView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (TaxRateState)reader.GetByte(this._ordinal2State);
