...
namespace DykBits.Crm.Data
{
    ...
    public partial class BeverageSubtypeDataAdapter : XmlDataAdapterBase<BeverageSubtypeView, BeverageSubtype, BeverageSubtypeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(BeverageSubtypeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (BeverageSubtypeState)reader.GetByte(this._ordinal1State);
            item.FileAs = reader.GetString(this._ordinal1FileAs);
            item.BeverageTypeId = reader.GetInt32(this._ordinal1BeverageTypeId);
        ...
        protected override void BindListResultToItem(BeverageSubtypeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (BeverageSubtypeState)reader.GetByte(this._ordinal2State);
            item.FileAs = reader.GetString(this._ordinal2FileAs);
            item.BeverageTypeId = reader.GetInt32(this._ordinal2BeverageTypeId);
        }
    }
}
