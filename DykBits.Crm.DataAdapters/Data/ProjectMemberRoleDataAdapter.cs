...
namespace DykBits.Crm.Data
{
    ...
    public partial class ProjectMemberRoleDataAdapter : DataAdapterBase<ProjectMemberRoleView, ProjectMemberRole, ProjectMemberRoleFilter>
    {
        ...
        protected override void BindBrowseResultToItem(ProjectMemberRoleView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ProjectMemberRoleState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(ProjectMemberRoleView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ProjectMemberRoleState)reader.GetByte(this._ordinal2State);
        ...
        protected override void BindGetItemResultToItem(ProjectMemberRole item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (ProjectMemberRoleState)reader.GetByte(this._ordinal0State);
        ...
        protected override void BindCreateCommand(SqlCommand command, ProjectMemberRole item)
        {
        ...
        protected override void BindUpdateCommand(SqlCommand command, ProjectMemberRole item)
        {
