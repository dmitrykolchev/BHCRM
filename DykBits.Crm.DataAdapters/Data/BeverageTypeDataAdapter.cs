...
namespace DykBits.Crm.Data
{
    ...
    public partial class BeverageTypeDataAdapter : XmlDataAdapterBase<BeverageTypeView, BeverageType, BeverageTypeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(BeverageTypeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (BeverageTypeState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(BeverageTypeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (BeverageTypeState)reader.GetByte(this._ordinal2State);
