...
namespace DykBits.Crm.Data
{
    ...
    public partial class DocumentTransitionDataAdapter : XmlDataAdapterBase<DocumentTransitionView, DocumentTransition, DocumentTransitionFilter>
    {
        ...
        protected override void BindBrowseResultToItem(DocumentTransitionView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (DocumentTransitionState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(DocumentTransitionView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (DocumentTransitionState)reader.GetByte(this._ordinal2State);
