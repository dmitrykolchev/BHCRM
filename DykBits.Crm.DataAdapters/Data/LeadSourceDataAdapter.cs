...
namespace DykBits.Crm.Data
{
    ...
    public partial class LeadSourceDataAdapter : DataAdapterBase<LeadSourceView, LeadSource, LeadSourceFilter>
    {
        ...
        protected override void BindBrowseResultToItem(LeadSourceView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (LeadSourceState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(LeadSourceView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (LeadSourceState)reader.GetByte(this._ordinal2State);
        ...
        protected override void BindGetItemResultToItem(LeadSource item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (LeadSourceState)reader.GetByte(this._ordinal0State);
        ...
        protected override void BindCreateCommand(SqlCommand command, LeadSource item)
        {
        ...
        protected override void BindUpdateCommand(SqlCommand command, LeadSource item)
        {
