...
namespace DykBits.Crm.Data
{
    ...
    public partial class ApplicationRoleDataAdapter : XmlDataAdapterBase<ApplicationRoleView, ApplicationRole, ApplicationRoleFilter>
    {
        ...
        protected override void BindBrowseResultToItem(ApplicationRoleView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ApplicationRoleState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(ApplicationRoleView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ApplicationRoleState)reader.GetByte(this._ordinal2State);
