...
namespace DykBits.Crm.Data
{
    ...
    public partial class MoneyOperationTypeDataAdapter : XmlDataAdapterBase<MoneyOperationTypeView, MoneyOperationType, MoneyOperationTypeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(MoneyOperationTypeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (MoneyOperationTypeState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(MoneyOperationTypeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (MoneyOperationTypeState)reader.GetByte(this._ordinal2State);
