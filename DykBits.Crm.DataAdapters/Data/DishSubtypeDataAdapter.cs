...
namespace DykBits.Crm.Data
{
    ...
    public partial class DishSubtypeDataAdapter : XmlDataAdapterBase<DishSubtypeView, DishSubtype, DishSubtypeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(DishSubtypeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (DishSubtypeState)reader.GetByte(this._ordinal1State);
            item.FileAs = reader.GetString(this._ordinal1FileAs);
            item.DishTypeId = reader.GetInt32(this._ordinal1DishTypeId);
        ...
        protected override void BindListResultToItem(DishSubtypeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (DishSubtypeState)reader.GetByte(this._ordinal2State);
            item.FileAs = reader.GetString(this._ordinal2FileAs);
            item.DishTypeId = reader.GetInt32(this._ordinal2DishTypeId);
        }
    }
}
