...
namespace DykBits.Crm.Data
{
    ...
    public partial class MarketingProgramTypeDataAdapter : DataAdapterBase<MarketingProgramTypeView, MarketingProgramType, MarketingProgramTypeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(MarketingProgramTypeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (MarketingProgramTypeState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(MarketingProgramTypeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (MarketingProgramTypeState)reader.GetByte(this._ordinal2State);
        ...
        protected override void BindGetItemResultToItem(MarketingProgramType item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (MarketingProgramTypeState)reader.GetByte(this._ordinal0State);
        ...
        protected override void BindCreateCommand(SqlCommand command, MarketingProgramType item)
        {
        ...
        protected override void BindUpdateCommand(SqlCommand command, MarketingProgramType item)
        {
