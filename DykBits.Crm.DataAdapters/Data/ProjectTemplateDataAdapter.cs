...
namespace DykBits.Crm.Data
{
    ...
    public partial class ProjectTemplateDataAdapter : XmlDataAdapterBase<ProjectTemplateView, ProjectTemplate, ProjectTemplateFilter>
    {
        ...
        private void InitializeBindBrowseResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal1Duration = reader.GetOrdinal("Duration");
        ...
        protected override void BindBrowseResultToItem(ProjectTemplateView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (ProjectTemplateState)reader.GetByte(this._ordinal1State);
            item.FileAs = reader.GetString(this._ordinal1FileAs);
            item.ProjectTypeId = reader.GetInt32(this._ordinal1ProjectTypeId);
            item.Duration = reader.GetInt32(this._ordinal1Duration);
        ...
        private void InitializeBindListResultToItem(SqlDataReader reader)
        {
            ...
            this._ordinal2Duration = reader.GetOrdinal("Duration");
            this._initialized2 = true;
        }
        protected override void BindListResultToItem(ProjectTemplateView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (ProjectTemplateState)reader.GetByte(this._ordinal2State);
            item.FileAs = reader.GetString(this._ordinal2FileAs);
            item.ProjectTypeId = reader.GetInt32(this._ordinal2ProjectTypeId);
            item.Duration = reader.GetInt32(this._ordinal2Duration);
        }
    }
}
