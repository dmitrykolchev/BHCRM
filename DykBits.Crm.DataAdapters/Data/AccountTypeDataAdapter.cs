...
namespace DykBits.Crm.Data
{
    ...
    public partial class AccountTypeDataAdapter : DataAdapterBase<AccountTypeView, AccountType, AccountTypeFilter>
    {
        ...
        protected override void BindBrowseResultToItem(AccountTypeView item, SqlDataReader reader)
        {
            InitializeBindBrowseResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal1Id);
            item.State = (AccountTypeState)reader.GetByte(this._ordinal1State);
        ...
        protected override void BindListResultToItem(AccountTypeView item, SqlDataReader reader)
        {
            InitializeBindListResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal2Id);
            item.State = (AccountTypeState)reader.GetByte(this._ordinal2State);
        ...
        protected override void BindGetItemResultToItem(AccountType item, SqlDataReader reader)
        {
            InitializeBindGetItemResultToItem(reader);
            item.Id = reader.GetInt32(this._ordinal0Id);
            item.State = (AccountTypeState)reader.GetByte(this._ordinal0State);
        ...
        protected override void BindCreateCommand(SqlCommand command, AccountType item)
        {
        ...
        protected override void BindUpdateCommand(SqlCommand command, AccountType item)
        {
