...
namespace Generator
{
    public class DocumentViewMap: EntityTypeConfiguration<DocumentView>
    {
        public DocumentViewMap()
        {
            ...
            this.Property(t => t.ClassName).HasColumnName("ClassName").HasColumnType("varchar").HasMaxLength(256).IsOptional();
            this.Property(t => t.ViewName).HasColumnName("ViewName").HasColumnType("varchar").HasMaxLength(256).IsRequired();
