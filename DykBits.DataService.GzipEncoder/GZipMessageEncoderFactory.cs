    ...
    internal class GZipMessageEncoderFactory : MessageEncoderFactory
    {
        ...
        class GZipMessageEncoder : MessageEncoder
        {
            ...
            static ArraySegment<byte> CompressBuffer(ArraySegment<byte> buffer, BufferManager bufferManager, int messageOffset)
            {
                ...
                using (DeflateStream gzStream = new DeflateStream(memoryStream, CompressionMode.Compress, true))
                {
            ...
            static ArraySegment<byte> DecompressBuffer(ArraySegment<byte> buffer, BufferManager bufferManager)
            {
                ...
                using (DeflateStream gzStream = new DeflateStream(memoryStream, CompressionMode.Decompress))
                {
                    while (true)
                    {
            ...
            public override Message ReadMessage(Stream stream, int maxSizeOfHeaders, string contentType)
            {
                ...
                DeflateStream gzStream = new DeflateStream(stream, CompressionMode.Decompress, false);
            ...
            {
                using (DeflateStream gzStream = new DeflateStream(stream, CompressionMode.Compress, true))
                {
