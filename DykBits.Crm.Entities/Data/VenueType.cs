...
namespace DykBits.Crm.Data
{
    ...
    public enum VenueTypeState : byte
    {
        [XmlEnum("0")]
        NotExist = 0,
        [XmlEnum("1")]
    ...
    public partial class VenueType : DataItem
    {
        public const string DataItemClassName = "VenueType";
        ...
        [XmlAttribute()]
        public VenueTypeState State
        {
            get
            {
                return (VenueTypeState)((IDataItem)this).State;
            }
            set
            {
