...
namespace DykBits.Crm.Data
{
    ...
    public enum ReasonTypeState : byte
    {
        [XmlEnum("0")]
        NotExist = 0,
        [XmlEnum("1")]
    ...
    public partial class ReasonType : DataItem
    {
        public const string DataItemClassName = "ReasonType";
        ...
        [XmlAttribute()]
        public ReasonTypeState State
        {
            get
            {
                return (ReasonTypeState)((IDataItem)this).State;
            }
            set
            {
