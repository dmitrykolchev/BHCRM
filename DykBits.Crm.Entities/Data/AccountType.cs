...
namespace DykBits.Crm.Data
{
    ...
    public enum AccountTypeState : byte
    {
        [XmlEnum("0")]
        NotExist = 0,
        [XmlEnum("1")]
    ...
    public partial class AccountType : DataItem
    {
        public const string DataItemClassName = "AccountType";
        ...
        [XmlAttribute()]
        public AccountTypeState State
        {
            get
            {
                return (AccountTypeState)((IDataItem)this).State;
            }
            set
            {
