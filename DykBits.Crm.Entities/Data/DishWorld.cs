...
namespace DykBits.Crm.Data
{
    ...
    public enum DishWorldState : byte
    {
        [XmlEnum("0")]
        NotExist = 0,
        [XmlEnum("1")]
    ...
    public partial class DishWorld : DataItem
    {
        public const string DataItemClassName = "DishWorld";
        ...
        [XmlAttribute()]
        public DishWorldState State
        {
            get
            {
                return (DishWorldState)((IDataItem)this).State;
            }
            set
            {
