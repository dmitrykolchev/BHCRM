...
namespace DykBits.Crm.Data
{
    ...
    public enum LeadSourceState : byte
    {
        [XmlEnum("0")]
        NotExist = 0,
        [XmlEnum("1")]
    ...
    public partial class LeadSource : DataItem
    {
        public const string DataItemClassName = "LeadSource";
        ...
        [XmlAttribute()]
        public LeadSourceState State
        {
            get
            {
                return (LeadSourceState)((IDataItem)this).State;
            }
            set
            {
