...
namespace DykBits.Crm.Data
{
    ...
    public enum IndustryState : byte
    {
        [XmlEnum("0")]
        NotExist = 0,
        [XmlEnum("1")]
    ...
    public partial class Industry : DataItem
    {
        public const string DataItemClassName = "Industry";
        ...
        [XmlAttribute()]
        public IndustryState State
        {
            get
            {
                return (IndustryState)((IDataItem)this).State;
            }
            set
            {
