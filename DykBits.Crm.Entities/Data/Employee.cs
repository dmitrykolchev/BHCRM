...
namespace DykBits.Crm.Data
{
    ...
    public enum EmployeeState : byte
    {
        [XmlEnum("0")]
        NotExist = 0,
        [XmlEnum("1")]
    ...
    public partial class Employee : DataItem
    {
        ...
        public const string EmployeeAccountIdProperty = "EmployeeAccountId";
        public const string AccountIdProperty = "AccountId";
        public const string TradeMarkIdProperty = "TradeMarkId";
        public const string PositionIdProperty = "PositionId";
        ...
        public const string DivisionIdProperty = "DivisionId";
        ...
        [Column(Name="IsEmployee", IsNullable=false)]
        [XmlAttribute()]
        public bool IsEmployee
        {
            get
            {
                return this._IsEmployeeField;
            }
            set
            {
                this._IsEmployeeField = value;
                InvokePropertyChanged("IsEmployee");
            }
        }
        [Column(Name="EmployeeAccountId", IsNullable=true)]
        [XmlAttribute()]
        public System.Nullable<int> EmployeeAccountId
        {
            ...
            set
            {
                ...
                InvokePropertyChanged("EmployeeAccountId");
            }
        }
        ...
        [Column(Name="PositionId", IsNullable=true)]
        [XmlAttribute()]
        public System.Nullable<int> PositionId
        {
            ...
            set
            {
                ...
                InvokePropertyChanged("PositionId");
            }
        }
        ...
        [Column(Name="DivisionId", IsNullable=true)]
        [XmlAttribute()]
        ...
        [Column(Name="UserId", IsNullable=true)]
        [XmlAttribute()]
