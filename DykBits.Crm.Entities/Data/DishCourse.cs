...
namespace DykBits.Crm.Data
{
    ...
    public enum DishCourseState : byte
    {
        [XmlEnum("0")]
        NotExist = 0,
        [XmlEnum("1")]
    ...
    public partial class DishCourse : DataItem
    {
        public const string DataItemClassName = "DishCourse";
        ...
        [XmlAttribute()]
        public DishCourseState State
        {
            get
            {
                return (DishCourseState)((IDataItem)this).State;
            }
            set
            {
