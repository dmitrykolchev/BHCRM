...
namespace DykBits.Crm.Data
{
    ...
    public enum DishServingState : byte
    {
        [XmlEnum("0")]
        NotExist = 0,
        [XmlEnum("1")]
    ...
    public partial class DishServing : DataItem
    {
        public const string DataItemClassName = "DishServing";
        ...
        [XmlAttribute()]
        public DishServingState State
        {
            get
            {
                return (DishServingState)((IDataItem)this).State;
            }
            set
            {
