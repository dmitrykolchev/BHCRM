...
namespace DykBits.Crm.Data
{
    partial class SalesInvoice
    {
        ...
        {
            var filter = new MoneyOperationFilter { AllStates = true, SalesInvoiceId = this.Id };
        ...
        private void ValidateBudgetItems()
        {
            ...
            IList<BudgetItemView> items = ListManager.GetList<BudgetItemView>(t => t.BudgetItemGroupId == budgetItemGroupId && t.Id != BudgetItem.Прочие_доходы_НДС && t.Id != BudgetItem.Доходы_по_ОВД_НДС);
