...
namespace DykBits.Crm.Data
{
    ...
    public enum VenuePlaceState : byte
    {
        [XmlEnum("0")]
        NotExist = 0,
        [XmlEnum("1")]
    ...
    public partial class VenuePlace : DataItem
    {
        public const string DataItemClassName = "VenuePlace";
        ...
        [XmlAttribute()]
        public VenuePlaceState State
        {
            get
            {
                return (VenuePlaceState)((IDataItem)this).State;
            }
            set
            {
