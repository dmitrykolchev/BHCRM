...
namespace DykBits.Crm.Data
{
    ...
    public enum ProductTypeState : byte
    {
        [XmlEnum("0")]
        NotExist = 0,
        [XmlEnum("1")]
    ...
    public partial class ProductType : DataItem
    {
        public const string DataItemClassName = "ProductType";
        ...
        public ProductTypeState State
        {
            get
            {
                return (ProductTypeState)((IDataItem)this).State;
            }
            set
            {
