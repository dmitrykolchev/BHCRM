create procedure [dbo].[MyServiceRequestBrowse] @filter xml
as
begin
	set nocount on;
	...
	declare @AllStates bit, @Id TIdentifier, @AccountId TIdentifier, @VenueProviderId TIdentifier, @ProjectMemberId TIdentifier, @PeriodStart date, @PeriodEnd date,
			@OrganizationId TIdentifier, @TradeMarkId TIdentifier, @CurrentEmployeeId TIdentifier, @ProjectId TIdentifier;
