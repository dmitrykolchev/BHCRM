create procedure [dbo].[ServiceRequestChangeState] @Id TIdentifier, @NewState TState, @Data xml
as
begin
	set nocount on;
	...
	from
		@Data.nodes('bhcrm:ServiceRequestChangeStateData') as T(c);
	...
	exec @result = [dbo].[DocumentStateLogCreateInternal] 'ServiceRequest', @Id, null, @LogData, @Comments;
