create procedure [dbo].[EstimatesTemplateUpdateInternal] @xml xml, @Id TIdentifier out
as
begin
	set nocount on;
	...
	delete [dbo].[EstimatesTemplateSection] where [EstimatesTemplateId] = @Id;
	if @@error <> 0
		return 1;
