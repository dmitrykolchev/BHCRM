...
begin
	...
	values
		(1, 1, @FileAs, @AccountId, @TradeMarkId, @PositionId, @ContactGroupId, @ContactRoleId,
	...
	values
		(1, @FileAs, 0x08, @TradeMarkId, @BusinessPhone, @MobilePhone, @Email, @OtherEmail, @Comments, getdate(),
		@CurrentUserId, getdate(), @CurrentUserId)
	if @@error <> 0
		return 1;
